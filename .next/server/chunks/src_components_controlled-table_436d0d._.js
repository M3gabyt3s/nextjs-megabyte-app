...
__turbopack_export_value__((__turbopack_import__) => {
    return Promise.all(["server/chunks/src_components_controlled-table_table-filter_tsx_80ee3d._.js"].map((chunk) => __turbopack_load__(chunk))).then(() => {
...
__turbopack_export_value__((__turbopack_import__) => {
    return Promise.all(["server/chunks/src_components_controlled-table_table-pagination_tsx_36be97._.js"].map((chunk) => __turbopack_load__(chunk))).then(() => {
